...
CREATE TABLE `_master_11__mitra` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin COMMENT='Mitra Kab lamongan';
...
CREATE TABLE `_master_12__opd` (
  ...
  `mitra___id` int(11) DEFAULT NULL,
...
CREATE TABLE `_master_13__user` (
  ...
  `opd___id` varchar(10) DEFAULT NULL,
  `status` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `_master_22__misi` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `urut` int(11) DEFAULT NULL,
  `visi___id` int(11) DEFAULT NULL,
  `misi` varchar(50) DEFAULT NULL,
  `status` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_misi_visi_id` (`visi___id`),
  CONSTRAINT `FK_misi_visi_id` FOREIGN KEY (`visi___id`) REFERENCES `_master_21__visi` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `_master_52__urusan` (
  ...
  `status` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_urusan_fungsi_id` (`fungsi`),
  CONSTRAINT `FK_urusan_fungsi_id` FOREIGN KEY (`fungsi`) REFERENCES `_master_51__fungsi` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `_master_53__program` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_program_urusan_id` (`urusan_id`),
  CONSTRAINT `FK_program_urusan_id` FOREIGN KEY (`urusan_id`) REFERENCES `_master_52__urusan` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
DROP TABLE IF EXISTS `indikatorrpjmd`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `pd_indikator`
--

DROP TABLE IF EXISTS `pd_indikator`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pd_indikator` (
  `id` int(11) DEFAULT NULL,
