...
CREATE TABLE `_master_81__tujuan_perangkat_daerah` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `opd___id___nama` int(11) NOT NULL,
  `sasaran_RPJMD___id___sasaran` int(11) NOT NULL,
...
CREATE TABLE `_master_83__sasaran_perangkat_daerah` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `opd___id___nama` int(11) NOT NULL,
  `tujuan_perangkat_daerah___id___nama` int(11) NOT NULL,
  `kode` int(11) DEFAULT NULL,
  `urut` int(11) DEFAULT NULL,
  `nama` varchar(50) NOT NULL,
  `status` varchar(50) DEFAULT NULL,
...
--
-- Table structure for table `_master_84__program_perangkat_daerah`
--

DROP TABLE IF EXISTS `_master_84__program_perangkat_daerah`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `_master_84__program_perangkat_daerah` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `opd___id___nama` int(11) NOT NULL,
  `sasaran_perangkat_daerah___id___nama` int(11) DEFAULT NULL,
...
--
-- Table structure for table `_t__indikator_RPJMD`
--

DROP TABLE IF EXISTS `_t__indikator_RPJMD`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `_t__indikator_RPJMD` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `_t__indikator_perangkat_daerah`
--

DROP TABLE IF EXISTS `_t__indikator_perangkat_daerah`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `_t__indikator_perangkat_daerah` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tipe` enum('Tujuan','Sasaran','Program','Kegiatan','Subkegiatan') NOT NULL,
  ...
  `mode` enum('Y','N') DEFAULT NULL COMMENT 'mode y = akumulatif (jan+feb+mar dst till des)\r\nmode n = non akumulatif angka berdiri sendiri',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-10-18 13:21:37
