...
class CMasterUser extends MY_Controller
{
	...
	protected $tag1 = "form_masteruser";
	public function save()
	{
		...
		} else if (!$this->id && empty($password)) {
			$this->flash('error', 'Password untuk user baru tidak boleh kosong');
	...
	public function resetpassword()
	{
		...
		$target_user = $this->MMasterUser->byId($this->id);
