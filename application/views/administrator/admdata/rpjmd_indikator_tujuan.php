	...
	<div class="card-body">
		...
		<div id="form-<?= $table_name ?>">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" placeholder="Tuliskan Nama Indikator" required <?= expandFieldAttr('indikator') ?> maxlength="200" />
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Tujuan RPJMD</label>
				<div class="col-sm-10">
					<?= expandFieldAttrSelectActive("kode", 'tujuan_RPJMD', 'tujuan') ?>
				</div>
			</div>
			<div class="form-group row">
		...
		<table id="tabelindikatortujuan" class="table table-bordered table-responsive table-data-init">
			...
			<tbody>
				<?= $f_expandTableCard($table_name . "::tipe=" . $tipe, 'id,kode::tujuan_RPJMD::tujuan,indikator,satuan,kondisiawal,formulasi,status', ['width_class_edit_dlg' => 'modal-lg']) ?>
			</tbody>
		</table>
	</div>
</div>
