				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="keterangan" name="keterangan"
							placeholder="Misal TA 2025 Murni atau TA 2025 Perubahan 1 (Maret)"
							...
							<td class="align-middle">
								<div class="btn-group">
									...
									<div class="dropdown-menu" role="menu">
										...
										<a class="dropdown-item" href="<?= site_url('admsistem/periode/setStatus/' . $periode->id) ?>">Ubah Status</a>
									</div>
								</div>
							</td>
						</tr>
