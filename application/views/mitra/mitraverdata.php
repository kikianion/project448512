  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"> Operator - Input Data</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <div class="col-lg-12">
            <div class="card card-info card-outline collapsed-card">
              <div class="card-header" data-card-widget="collapse">
                <h5 class="card-title m-0"><b>Capaian Kinerja</b></h5>
              ...
              <div class="card-body">
                ...
                <table  class="table table-bordered table-fit">
                  ...
                  <tr>
                    ...
                    <td class="align-middle">Nama Indikator Sasaran 1 xxxxx</td>
                    <td class="align-middle">Misal 2025 - 01 (2025 awal)</td>
                    <td class="align-middle bg-warning" data-toggle="modal" data-target="#ubah-target">76</td>
                    <td class="align-middle">Satuan Data</td>
                    <td class="align-middle">-</td>
                    <td class="align-middle">-</td>
                    <td class="align-middle bg-warning" data-toggle="modal" data-target="#ubah-capaian">-</td>
                    <td class="align-middle bg-warning" data-toggle="modal" data-target="#ubah-capaian">-</td>
                    <td class="align-middle bg-info">-</td>
                    <td class="align-middle bg-info">-</td>
                    <td class="align-middle bg-info">-</td>
                    <td class="align-middle bg-info">-</td>
                    <td class="align-middle bg-info">-</td>
                  ...
                  <tr>
                    <td class="align-middle">Tujuan</td>
                    <td class="align-middle">Nama Indikator Tujuan 1 xxxxx</td>
                    <td class="align-middle">Misal 2025 - 01 (2025 awal)</td>
                    <td class="align-middle bg-warning" data-toggle="modal" data-target="#ubah-target">76</td>
                    <td class="align-middle">Satuan Data</td>
                    <td class="align-middle">-</td>
                  ...
                  <tr>
                    <td class="align-middle">Sub Kegiatan</td>
                    <td class="align-middle">Nama Indikator Sasaran 1 xxxxx</td>
                    <td class="align-middle">Misal 2025 - 01 (2025 awal)</td>
                    <td class="align-middle bg-warning" data-toggle="modal" data-target="#ubah-target">76</td>
                    <td class="align-middle">Satuan Data</td>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="card card-info card-outline collapsed-card">
              <div class="card-header" data-card-widget="collapse">
                <h5 class="card-title m-0"><b>Serapan Anggaran per Sub Kegiatan</b></h5>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-card-widget="collapse">
                    <i class="fas fa-minus"></i>
                  </button>
              ...
              <div class="card-body">
                ...
                <table id="tabeluser" class="table table-bordered table-fit">
                  ...
                  <tbody>
                  <tr>
                    <td class="align-middle">Sub Kegiatan xxxxxx</td>
                    <td class="align-middlebg-warning" data-toggle="modal" data-target="#ubah-target">250.000.000</td>
                    <td class="align-middle">Misal 2025 - 01 (2025 awal)</td>
                    <td class="align-middle">-</td>
                    <td class="align-middle">-</td>
                    <td class="align-middle bg-warning" data-toggle="modal" data-target="#ubah-capaian">500.000</td>
                    <td class="align-middle bg-warning" data-toggle="modal" data-target="#ubah-capaian">12.000.000</td>
                    <td class="align-middle bg-info">-</td>
                    <td class="align-middle bg-info">-</td>
                    <td class="align-middle bg-info">-</td>
                    <td class="align-middle bg-info">-</td>
                    ...
                    <td class="align-middle bg-info">-</td>
                    <td class="align-middle bg-info">-</td>
                    <td class="align-middle">12.500.000</td>
...
<div class="modal fade" id="ubah-target">
  <div class="modal-dialog modal-md modal-outline">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Form Ubat Target Capaian</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        Form Untuk Merubah Target Indikator Pada Periode XXX
        <p>
      <div class="modal-footer pull-right">
          <button type="button" class="btn btn-info">Oke</button>
      </div>
...
<div class="modal fade" id="ubah-capaian">
  <div class="modal-dialog modal-md modal-outline">
    <div class="modal-content">
      <div class="modal-header">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-4">
            <input  class="form-control" xid="satuan" placeholder="Satuan Indikator">
          </div>
          <label for="inputEmail3" class="col-sm-2 col-form-label">Awal</label>
          <div class="col-sm-4">
            <input  class="form-control" xid="satuan" placeholder="Kondisi Awal Periode">
          </div>
        </div>
        <div class="form-group row">
