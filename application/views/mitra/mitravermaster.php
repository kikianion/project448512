      ...
      <div class="container-fluid">
            ...
            <div class="card card-info card-outline collapsed-card">
              ...
              <div class="card-body">
                <div class="form-group row">
                  <div class="col-sm-9">
                    <select class="form-control">
                      <option selected>Dinas 1</option>
                      <option>Dinas 2</option>
                      <option>Dinas 3</option>
                      <option>Dinas 4</option>
                      <option>dst...</option>
                    </select>
                  </div>
                  <div class="col-sm-3">
                    <button type="submit" class="btn btn-primary pull-right">Verifikasi Semua</button>  
                  </div>
                </div>
                ...
                <table id="tabeluser1" class="table table-bordered table-fit">
                  ...
                  <tbody>
                  <tr data-toggle="modal" data-target="#ubah-status-urusan">
                    <td class="align-middle">DInas xxxxxxx</td>
                    <td class="align-middle">2.0.0</td>
            ...
            <div class="card card-info card-outline collapsed-card">
              ...
              <div class="card-body">
                ...
                <table id="tabeluser" class="table table-bordered table-fit">
                  ...
                  <tbody>
                  <tr data-toggle="modal" data-target="#ubah-status-urusan">
                    <td class="align-middle">Dinas 123</td>
                    <td class="align-middle">2.0.0</td>
                  ...
                  <tr data-toggle="modal" data-target="#ubah-status-urusan" >
                    <td class="align-middle">Dinas 456</td>
                    <td class="align-middle">2.0.0</td>
                    <td class="align-middle">12</td>
            ...
            <div class="card card-info card-outline collapsed-card">
              ...
              <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input  class="form-control" id="fungsi" placeholder="Tuliskan Nama Program">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Kode</label>
                  <div class="col-sm-4">
                    <input  class="form-control" id="fungsi" placeholder="Kode">
                  </div>
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Urut</label>
                  <div class="col-sm-4">
                    <input  class="form-control" id="fungsi" placeholder="Urut">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <table id="tabeluser" class="table table-bordered table-fit">
                  ...
                  <tr>
                    ...
                    <th>Urut</th>
                    <th>Program</th>
                    <th>Sasaran PD yang diinterfensi</th>
                    <th>Urusan PD yang diinterfensi</th>
                    <th>Status</th>
                    <th>Tindakan</th>
                  </tr>
                  </thead>
                  ...
                  <tr>
                    ...
                    <td class="align-middle">Nama Program</td>
                    <td class="align-middle">Tujuan PD Misal Tujuan xxxxxxx</td>
                    <td class="align-middle">Sasaran Perangkat Daerah xxxxxxxxxxxxxxx1</td>
                    <td class="align-middle">Aktif</td>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="card card-info card-outline collapsed-card">
              <div class="card-header" data-card-widget="collapse">
                <h5 class="card-title m-0"><b>Kegiatan</b></h5>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-card-widget="collapse">
                    <i class="fas fa-minus"></i>
                  </button>
              ...
              <div class="card-body">
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Nama</label>
                  <div class="col-sm-10">
                    <input  class="form-control" id="fungsi" placeholder="Tuliskan Nama Ke">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Kode</label>
                ...
                <table id="tabeluser" class="table table-bordered table-fit">
                  ...
                  <tr>
                    <th>Kode</th>
                    <th>Urut</th>
                    <th>Program PD yang diinterfensi</th>
                    <th>Kegiatan PD</th>
                    <th>Status</th>
                    <th>Tindakan</th>
                  </tr>
          ...
          <div class="col-lg-6">
            <div class="card card-info card-outline collapsed-card">
              <div class="card-header" data-card-widget="collapse">
                <h5 class="card-title m-0"><b>Indikator Kegiatan Perangkat Daerah</b></h5>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-card-widget="collapse">
                    <i class="fas fa-minus"></i>
                  </button>
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control">
                      <option selected>Pilih salah satu Kegiatan PD yang Aktif</option>
                      <option>Kegiatan Aktif 1</option>
                      <option>Kegiatan Aktif 2</option>
                      <option>Kegiatan Aktif 3</option>
                      <option>dst...</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Formulasi</label>
                  <div class="col-sm-10">
                    <textarea id="summernote4" rows="4"></textarea>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Target</label>
        ...
        <div class="row">
            ...
            <div class="card card-info card-outline collapsed-card">
              ...
              <div class="card-body">
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Nama</label>
                  <div class="col-sm-10">
                    <input  class="form-control" id="fungsi" placeholder="Tuliskan Nama Sasaran">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Kode</label>
                ...
                <table id="tabeluser" class="table table-bordered table-fit">
                  ...
                  <tr>
                    <th>Kode</th>
                    <th>Urut</th>
                    <th>Kegiatan PD yang diinterfensi</th>
                    <th>Sub Kegiatan PD</th>
                    <th>Status</th>
                    <th>Tindakan</th>
                  </tr>
                  </thead>
                  <tbody>
                  <tr>
                    <td class="align-middle">20.09.34</td>
                    <td class="align-middle">2</td>
                    <td class="align-middle">Kegiatan PD xxxxxxx</td>
                    <td class="align-middle">Sub Kegiatan PD xxxxxxx</td>
                    <td class="align-middle">Aktif</td>
                    <td class="align-middle">
                      <div class="btn-group">
                      <button type="button" class="btn btn-default">Tindakan</button>
          ...
          <div class="col-lg-6">
            <div class="card card-info card-outline collapsed-card">
              <div class="card-header" data-card-widget="collapse">
                <h5 class="card-title m-0"><b>Indikator Sub Kegiatan Perangkat Daerah</b></h5>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-card-widget="collapse">
                    <i class="fas fa-minus"></i>
                  </button>
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control">
                      <option selected>Pilih salah satu Sub Kegiatan PD yang Aktif</option>
                      <option>Sub Kegiatan Aktif 1</option>
                      <option>Sub Kegiatan Aktif 2</option>
                      <option>Sub Kegiatan Aktif 3</option>
                      <option>dst...</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Formulasi</label>
                  <div class="col-sm-10">
                    <textarea id="summernote5" rows="4"></textarea>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Target</label>
